...
const KINDS = ["REPORT", "SPEC", "NOTES", "SUBMISSION", "REFERENCE"];
...
export default function Archive() {
  ...
  const removeDoc = async (id) => {
    ...
    try {
      await jsonOrThrow(await fetch(`/api/documents/${id}`, { method: "DELETE" }));
    } catch (e) {
...
/* ---------- row ---------- */
function Row({ doc, idx, onOpen, onRemove }) {
...
/* ---------- new entry ---------- */
function NewEntry({ onSaved, onCancel }) {
